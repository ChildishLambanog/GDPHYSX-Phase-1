...
uniform vec4 objColor; //new addition

//out vec4 objectColor; //new addition
...
void main()
{
	...
	//vec4 objColor2 = vec4(1.0f, 0.0f, 0.0f, 1.0f); //new addition


	//vec4 objColor2 = vec4(objColor.r,0,0, 1); //new addition
	...
	//FragColor = vec4(result, 1.0)  * texture(tex0, texCoord); //using with texture

	//FragColor = vec4(result, 1.0) * objColor; //using with object color new addition
