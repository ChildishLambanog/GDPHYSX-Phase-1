...
public:
	...
	Model3D(glm::vec3 pos, std::vector<GLfloat>* fullVertexData, GLuint* VAO, Shader* shaderProg);
	//might delete later
	...
	void setRendering(Shader* shaderProg, GLuint* VAO, std::vector<GLfloat>* fullVertexData);
